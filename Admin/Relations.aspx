<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPages/Master.Master" AutoEventWireup="true" CodeBehind="Relations.aspx.cs" Inherits="SKF.Admin.Relations" %>
     ...
     <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add New Relations
                </li>
            </ol>
        </section>
        <!--section ends-->
                    ...
                    <div class="panel  form-horizontal">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw ti-star"></i>Relations Details
                            </h3>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtRelationsName" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        <asp:ListView ID="Lst_Relations" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p>
                                                            <asp:LinkButton ID="lnkEdit" class="btn btn-primary btn-xs" OnClick="lnkEdit_Click" CommandArgument='<%# Eval("relation_id") %>' runat="server"><span
                                                                    class="fa fa-fw ti-pencil"></span></asp:LinkButton>
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <p>
                                                            <asp:LinkButton ID="lnkDelete" OnClientClick="return(confirm('Are you sure you want to delete this record?'))" OnClick="lnkDelete_Click" CommandArgument='<%# Eval("relation_id") %>' class="btn btn-danger btn-xs" runat="server"><span
