<%@ Page Title="Student Details" Language="C#" MasterPageFile="~/Admin/MasterPages/Master.Master" AutoEventWireup="true" CodeBehind="Add_Students.aspx.cs" Inherits="SKF.Admin.Add_Students" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" type="text/css" href="Styles/css/datepicker.css">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" runat="server">
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add New Student
                </li>
            </ol>
        </section>
        <!--section ends-->
                    ...
                    <div class="panel form-horizontal">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw ti-star"></i>Student Details
                            </h3>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtStuName" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="val-username">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtStuEmail" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="val-username">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtStuPhone" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtStuZip" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="val-username">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtStuDOB" placeholder="DD/MM/YYYY" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="val-username">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtStuDOJ" class="form-control" placeholder="DD/MM/YYYY" runat="server"></asp:TextBox>
                                </div>
    ...
    <script src="Styles/vendors/datedropper/datedropper.js" type="text/javascript"></script>
</asp:Content>
