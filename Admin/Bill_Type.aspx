<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPages/Master.Master" AutoEventWireup="true" CodeBehind="Bill_Type.aspx.cs" Inherits="SKF.Admin.Bill_Type" %>
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add New Bill Type
                </li>
            </ol>
        </section>
        <!--section ends-->
                    ...
                    <div class="panel  form-horizontal">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw ti-star"></i>Bill Type Details
                            </h3>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtBillTypeName" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="val-username">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtBillAmount" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                        ...
                                        <asp:ListView ID="Lst_Designation" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p>
                                                            <asp:LinkButton ID="lnkEdit" class="btn btn-primary btn-xs" OnClick="lnkEdit_Click" CommandArgument='<%# Eval("bill_type_id") %>' runat="server"><span
                                                                    class="fa fa-fw ti-pencil"></span></asp:LinkButton>
                                                        </p>
                                                    </td>
                                                    <td>
                                                        <p>
                                                            <asp:LinkButton ID="lnkDelete" OnClientClick="return(confirm('Are you sure you want to delete this record?'))" OnClick="lnkDelete_Click" CommandArgument='<%# Eval("bill_type_id") %>' class="btn btn-danger btn-xs" runat="server"><span
