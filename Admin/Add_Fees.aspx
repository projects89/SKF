<%@ Page Title="Fees Details" Language="C#" MasterPageFile="~/Admin/MasterPages/Master.Master" AutoEventWireup="true" CodeBehind="Add_Fees.aspx.cs" Inherits="SKF.Admin.Add_Fees" %>
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="Fees.aspx">Fees</a>
                </li>
                <li class="active">Add New Fees
                </li>
            </ol>
        </section>
        <!--section ends-->
                    ...
                    <div class="panel form-horizontal">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="fa fa-fw ti-star"></i>Fees Details
                            </h3>
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:UpdatePanel ID="updateSchooName" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="DropSchooName" AutoPostBack="true" OnSelectedIndexChanged="DropSchooName_SelectedIndexChanged" class="form-control" runat="server"></asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:UpdatePanel ID="updateStuName" runat="server">
                                        <ContentTemplate>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <asp:DropDownList ID="DropBillType" class="form-control" runat="server"></asp:DropDownList>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="val-username">
                                ...
                                <div class="col-md-6">
                                    <asp:TextBox ID="txtBillReceiveAmount" class="form-control" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="val-username">
                                ...
                                <div class="col-md-6">
                                    <asp:UpdatePanel ID="updateStaffName" runat="server">
                                        <ContentTemplate>
                                            <asp:DropDownList ID="DropStaffName" class="form-control" runat="server"></asp:DropDownList>
                                        </ContentTemplate>
                                    </asp:UpdatePanel>
